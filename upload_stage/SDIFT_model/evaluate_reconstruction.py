...
def main():
    ...
    parser.add_argument("--recon_sample_index", type=int, default=None)
    parser.add_argument("--truth_sample_index", type=int, default=None)
    ...
    recon_sample_index = args.sample_index if args.recon_sample_index is None else args.recon_sample_index
    truth_sample_index = args.sample_index if args.truth_sample_index is None else args.truth_sample_index
    pred = load_recon(args.recon_mat, sample_index=recon_sample_index, recon_key=args.recon_key)
    truth = load_truth(args.truth_path, sample_index=truth_sample_index, dataset_key=args.truth_dataset_key)
    ...
    result = {
        ...
        "recon_sample_index": int(recon_sample_index),
        "truth_sample_index": int(truth_sample_index),
